...
function thxbob.lib.recipe.add_new_ingredient(recipe, item)
  if data.raw.recipe[recipe] and type(item) == "table" and thxbob.lib.item.get_type(thxbob.lib.item.basic_item(item).name) then
    ...
    if not thxbob.lib.item.get_type(thxbob.lib.item.basic_item(item).name) then
...
function thxbob.lib.recipe.add_new_difficulty_ingredient(recipe, difficulty, item)
  if data.raw.recipe[recipe] and type(item) == "table" and thxbob.lib.item.get_type(thxbob.lib.item.basic_item(item).name) and (difficulty == "normal" or difficulty == "expensive") then
